...
public:
//    static bool pred(pathAndPoint pap){
//
//        return pap.first.first == p.first && pap.first.second == p.second;
//    }
    std::string search();
...
//        this->openTrack.insert(initialStatePoint);
    }
...
//    std::set<pathAndPoint> openTrack;
